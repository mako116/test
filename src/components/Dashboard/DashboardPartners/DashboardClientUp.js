...
const DashboardsClientpdate = () => {
    ...
    const handleSubmi = async (e,id)=>{
     ...
     const res = await axios.patch(`http://backend.imagepluseyeclinic.com/api/clients/${id}`, formData )
     console.log(res)
...
export default DashboardsClientpdate
